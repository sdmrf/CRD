...
const RegisterCriminal = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const { criminalId, fullName, gender, dob, mobileNumber, relativeFullName, relativePhoneNumber, aadharNumber, mugshots } = formData;
    ...
    await contract.registerCriminal(criminalId, fullName, gender, dob, mobileNumber, aadharNumber, address, relativeFullName, relativePhoneNumber, mugshots);
